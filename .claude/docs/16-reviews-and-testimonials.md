...
| Question                                | Decision                                                                                                                                                                                                                                                                                                                                                |
| --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| How does the homepage choose reviews?   | **Explicit admin toggle** `featuredOnHome`. Home shows only flagged approved reviews. Section hides when none are flagged. No automatic "top-rated" magic. _(M1.28k: order is now the admin's `Review.sortOrder` drag order — "סדר בעמוד הבית" panel in `/admin/reviews` → `POST /api/admin/reviews/reorder` — `createdAt desc` is only the tiebreak.)_ |
