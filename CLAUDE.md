...
| [10-devops](.claude/docs/10-devops.md)                                     | Vercel deploy, **single prod-only Supabase DB**, env vars, scripts, storage |
...
| [14-instagram-integration](.claude/docs/14-instagram-integration.md)       | Curated Instagram highlights on the homepage                                |
| [15-analytics](.claude/docs/15-analytics.md)                               | GA4 + GTM + Meta Pixel, consent, WhatsApp tracking                          |
| [16-reviews-and-testimonials](.claude/docs/16-reviews-and-testimonials.md) | Unified `Review` table, homepage reviews, global reviews, review images     |
